...
- [x] *EN* Course learning.sap [Introduction to SAP Cloud Application Programming Model](https://learning.sap.com/courses/introduction-to-sap-cloud-application-programming-model)
...
- [x] *EN* Hands-on capire [Getting Started](https://cap.cloud.sap/docs/get-started/#initial-setup)
...
- [x] *EN* Course learning.sap [Developing UIs with SAPUI5](https://learning.sap.com/courses/developing-uis-with-sapui5-1)
- [x] *EN* ui5.sap [Get Started: Setup, Tutorials, and Demo Apps](https://ui5.sap.com/#/topic/8b49fc198bf04b2d9800fc37fecbb218)
...
- [x] *EN* Course learning.sap [Developing an SAP Fiori Elements App Based on a CAP OData V4 Service](https://learning.sap.com/courses/developing-an-sap-fiori-elements-app-based-on-a-cap-odata-v4-service)
- [x] *EN* capire [Serving SAP Fiori UIs](https://cap.cloud.sap/docs/guides/uis/fiori)
- [x] *EN* ui5.sap [Developing Apps with SAP Fiori Elements](https://ui5.sap.com/#/topic/03265b0408e2432c9571d6b3feb6b1fd)
...
- [x] *EN* capire [CDS Docs](https://cap.cloud.sap/docs/cds/)
- [x] *EN* Course learning.sap [Introduction to SAP Cloud Application Programming Model](https://learning.sap.com/courses/introduction-to-sap-cloud-application-programming-model)
...
- [x] *EN* help.sap [What Is the SAP Authorization and Trust Management Service?](https://help.sap.com/docs/btp/sap-business-technology-platform/what-is-sap-authorization-and-trust-management-service?locale=en-US)
- [x] *PT* help.sap [O que é o serviço SAP Authorization and Trust Management?](https://help.sap.com/docs/btp/sap-business-technology-platform/what-is-sap-authorization-and-trust-management-service?locale=pt-BR)
- [x] *EN* SAP Discovery Center [SAP Authorization and Trust Management Service](https://discovery-center.cloud.sap/serviceCatalog/authorization-and-trust-management-service?region=all)
...
- [x] *EN* SAP Discovery Center [SAP Destination Service](https://discovery-center.cloud.sap/serviceCatalog/destination-service)
- [x] *EN* help.sap [Destination Service](https://help.sap.com/docs/connectivity/sap-btp-connectivity-cf/destination-service?locale=en-US)
- [x] *EN* SAP Discovery Center [SAP Connectivity Service](https://discovery-center.cloud.sap/serviceCatalog/connectivity-service)
- [x] *EN* help.sap [Connectivity Service](https://help.sap.com/docs/connectivity/sap-btp-connectivity-cf/connectivity-service-bd2d4f45e0494121a058ad9c015ba348?locale=en-US)
- [x] *EN* help.sap [Cloud Connector](https://help.sap.com/docs/connectivity/sap-btp-connectivity-cf/cloud-connector?locale=en-US)
...
- [x] *EN* capire [Configuration Profiles](https://cap.cloud.sap/docs/node.js/cds-env#profiles)
- [x] *EN* capire [Authentication in Hybrid Setup](https://cap.cloud.sap/docs/node.js/authentication#hybrid-setup)
- [x] *EN* capire [Using SQLite for Development](https://cap.cloud.sap/docs/guides/databases/sqlite)
- [x] *EN* [Lucas Rigo](https://github.com/lucasrigo-numen)'s blogs.sap [SAP CAP Lessons Learned: Hybrid Development with On-Premise SAP System](https://community.sap.com/t5/technology-blog-posts-by-members/sap-cap-lessons-learned-hybrid-development-with-on-premise-sap-system/ba-p/13972708)
...
- [x] *PT* Moovi [Fiori Freestyle](https://moovi.curseduca.pro/m/lessons/fiori-freestyle-1734443760098)
- [x] *EN* ui5.sap [SAPUI5 API Reference](https://ui5.sap.com/#/api)
- [x] *EN* ui5.sap [SAPUI5 Samples](https://ui5.sap.com/#/controls)
- [x] *EN* ui5.sap [Extending Generated Apps Using App Extensions](https://ui5.sap.com/#/topic/340cdb2ba97c4843979f905a70a327ee)
- [x] *EN* ui5.sap [SAP Fiori Development Portal](https://ui5.sap.com/test-resources/sap/fe/core/fpmExplorer/index.html)
...
- [x] *EN* blogs.sap [A Fiori Launchpad Sandbox for all your CAP-based projects - Overview](https://community.sap.com/t5/technology-blog-posts-by-members/a-fiori-launchpad-sandbox-for-all-your-cap-based-projects-overview/ba-p/13528514)
- [x] *EN* blogs.sap [A Fiori Launchpad Sandbox for all your CAP-based projects – Sample project setup](https://community.sap.com/t5/technology-blog-posts-by-members/a-fiori-launchpad-sandbox-for-all-your-cap-based-projects-sample-project/ba-p/13528575)
...
- [x] *EN* [HANA Guide](https://cap.cloud.sap/docs/guides/databases/hana)
- [x] *EN* [Lucas Rigo](https://github.com/lucasrigo-numen)'s blogs.sap [SAP CAP Lessons Learned: SQLite is single threaded, HANA is not](https://community.sap.com/t5/technology-blog-posts-by-members/sap-cap-lessons-learned-sqlite-is-single-threaded-hana-is-not/ba-p/13972788)
...
- [x] *EN* capire [Importing APIs](https://cap.cloud.sap/docs/guides/integration/calesi#odata-apis)
...
- [x] *EN* [capire](https://cap.cloud.sap/docs/)
